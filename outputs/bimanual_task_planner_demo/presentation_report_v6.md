# OpenArm 双臂上层任务规划系统 Demo V6 汇报记录
...
V6 会为每个任务生成 waypoint-based path plan，保存到：`E:\FL_Personal\openarm_mujoco-master\openarm_mujoco-master\outputs\bimanual_task_planner_demo\path_plan_v6.csv`。每个 waypoint 包含目标位置、motion_type、safety_role、expected_state 和 safe 标记。
...
- Task log: `E:\FL_Personal\openarm_mujoco-master\openarm_mujoco-master\outputs\bimanual_task_planner_demo\task_log_v6.csv`
- Execution plan: `E:\FL_Personal\openarm_mujoco-master\openarm_mujoco-master\outputs\bimanual_task_planner_demo\execution_plan_v6.csv`
- Path plan: `E:\FL_Personal\openarm_mujoco-master\openarm_mujoco-master\outputs\bimanual_task_planner_demo\path_plan_v6.csv`
- Summary JSON: `E:\FL_Personal\openarm_mujoco-master\openarm_mujoco-master\outputs\bimanual_task_planner_demo\task_summary_v6.json`
- State machine Mermaid: `E:\FL_Personal\openarm_mujoco-master\openarm_mujoco-master\outputs\bimanual_task_planner_demo\state_machine_v6.mmd`
- Runbook: `E:\FL_Personal\openarm_mujoco-master\openarm_mujoco-master\outputs\bimanual_task_planner_demo\demo_runbook_v6.txt`
